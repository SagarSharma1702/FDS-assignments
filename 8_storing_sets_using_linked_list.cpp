...
students like butterscotch ice-cream. Write C++ program to store two sets using linked list. compute
and displayA. Set of students who like both vanilla and butterscotch
B. Set of students who like either vanilla or butterscotch or not both
Number of students who like neither vanilla nor butterscotch should keep track of the records that
